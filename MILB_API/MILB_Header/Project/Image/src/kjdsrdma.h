...
struct _IoRdma
{
    ...
    unsigned char dmy28869400288697ff[0x28869800 - 0x28869400]; /* 2886_9400 - 2886_97FFh */

    unsigned char dmy2886980028869fff[0x2886A000 - 0x28869800]; /* 2886_9800 - 2886_9FFFh */
};
