...
union _IoMcswfi
{
    ...
    struct
    {
        unsigned long ca70Wfi :1;
        unsigned long ca71Wfi :1;
        unsigned long ca72Wfi :1;
        unsigned long ca73Wfi :1;
        unsigned long ca70Wfe :1;
        unsigned long ca71Wfe :1;
        unsigned long ca72Wfe :1;
        unsigned long ca73Wfe :1;
        unsigned long :24;
    } bit;
};
...
struct _IoMcc
{
    unsigned char dmyA000A00f[0xA010 - 0xA000]; // 1C26_(A000 - A00Fh) Reserved
    IoMcswfi mcswfi;                         // 1C26_(A010 - A013h) Standby WFI and WFE monitor Register
    unsigned char dmyA014Afff[0xB000 - 0xA014]; // 1C26_(A014 - AFFFh) Reserved
};
