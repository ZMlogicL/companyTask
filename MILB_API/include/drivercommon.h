...
#define DRIVER_TYPE_COMMON							(driver_common_get_type ())
#define DRIVER_COMMON(obj)								(G_TYPE_CHECK_INSTANCE_CAST ((obj), DRIVER_TYPE_COMMON, DriverCommon))
#define DRIVER_COMMON_CLASS(klass)				(G_TYPE_CHECK_CLASS_CAST((klass), DRIVER_TYPE_COMMON, DriverCommonClass))
#define DRIVER_IS_COMMON(obj)							(G_TYPE_CHECK_INSTANCE_TYPE ((obj), DRIVER_TYPE_COMMON))
#define DRIVER_IS_COMMON_CLASS(klass)		    (G_TYPE_CHECK_CLASS_TYPE ((klass), DRIVER_TYPE_COMMON))
#define DRIVER_COMMON_GET_CLASS(obj)			(G_TYPE_INSTANCE_GET_CLASS ((obj), DRIVER_TYPE_COMMON, DriverCommonClass))
...
struct 				   _DriverCommon;
typedef struct _DriverCommon 							DriverCommon;
typedef struct _DriverCommonClass 					DriverCommonClass;
typedef struct _DriverCommonPrivate 				DriverCommonPrivate;

struct _DriverCommon{
	GObject parent;
};

struct _DriverCommonClass{
	GObjectClass parentclass;
};


GType 								driver_common_get_type(void) G_GNUC_CONST;
DriverCommon* 			driver_common_new(void);
