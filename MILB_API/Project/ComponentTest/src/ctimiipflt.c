...
#define CtImIipFlt_DDIM_PRINT(arg)		{ddim_user_custom_printf arg;}		/**< printf function inside DDIM */
#endif
...
kint32 ct_im_iip_9_1_1( CtImIipFlt *self )
{
	...
	const kuint32	 unitidBitmask = ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_LD1 | ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_CSC1 |
			ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_FLT | ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_SL2;
	const kuint32	 pixidBitmask = ImIipStruct_E_IM_IIP_PIXID_4 | ImIipStruct_E_IM_IIP_PIXID_5;
	const ImIipStructEImIipUnitId srcUnitid = ImIipStruct_E_IM_IIP_UNIT_ID_LD1;
	const ImIipStructEImIipUnitId filter1Unitid = ImIipStruct_E_IM_IIP_UNIT_ID_CSC1;
	const ImIipStructEImIipUnitId filter2Unitid = ImIipStruct_E_IM_IIP_UNIT_ID_FLT;
	...
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));
	...
	*onedUnitInf = gCtImIipParam1DlBase;
	...
	onedCfg.unitCtrl = ImIipDefine_D_IM_IIP_HW_CTRL_SWTRG;
	onedCfg.chainEnable = ImIipDefine_D_IM_IIP_PLDUNIT_CHAIN_DISABLE;
...
sizeof(ImIipParamCsc) ));
	...
	*cscUnitInf = gCtImIipParamCscBase;
	...
	cscCfg.unitCtrl = ImIipDefine_D_IM_IIP_HW_CTRL_SWTRG;
	cscCfg.chainEnable = ImIipDefine_D_IM_IIP_PLDUNIT_CHAIN_DISABLE;
...
sizeof(ImIipParamFlt) ));
	...
	*fltUnitInf = gCtImIipParamFltBase;
	...
	spfCfg.unitCtrl = ImIipDefine_D_IM_IIP_HW_CTRL_SWTRG;
	spfCfg.chainEnable = ImIipDefine_D_IM_IIP_PLDUNIT_CHAIN_DISABLE;
...
sizeof(ImIipParamSts) ));
	...
	*slUnitInf = gCtImIipParamStsBase;
	...
	priv->ercd = Im_IIP_Ctrl_PIXFMTTBL( srcPixid, &pixfmtTbl0 );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_PIXFMTTBL( dstPixid, &pixfmtTbl1 );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_SWTRG_Unit( srcUnitid, &onedCfg );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_SWTRG_Unit( filter1Unitid, &cscCfg );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_SWTRG_Unit( filter2Unitid, &spfCfg );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_SWTRG_Unit( dstUnitid, &slCfg );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));
	...
	priv->ercd = Im_IIP_Start_SWTRG( filter2Unitid, ImIipDefine_D_IM_IIP_SWTRG_ON );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "WaitEnd\n" ));
	priv->ercd = Im_IIP_Wait_End( &waitFactorResult, waitFactor, ImIipDefine_D_IM_IIP_OR_WAIT, 30 );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x factor=0x%x\n", priv->ercd, waitFactorResult ));
	if( priv->ercd != DriverCommon_D_DDIM_OK ) {
...
kint32 ct_im_iip_9_1_2( CtImIipFlt *self )
{
	...
	ImIipUnitCfg slCfg;
	kuint32 waitFactorResult = 0;
	const kuint32	 waitFactor = ImIipDefine_D_IM_IIP_INT_FACTOR_AXIERR | ImIipDefine_D_IM_IIP_INT_FACTOR_SL6END;
	...
	const kuint32	 pixidBitmask = ImIipStruct_E_IM_IIP_PIXID_10 | ImIipStruct_E_IM_IIP_PIXID_11;
	const ImIipStructEImIipUnitId srcUnitid = ImIipStruct_E_IM_IIP_UNIT_ID_LD1;
	const ImIipStructEImIipUnitId filter1Unitid = ImIipStruct_E_IM_IIP_UNIT_ID_CSC2;
	const ImIipStructEImIipUnitId filter2Unitid = ImIipStruct_E_IM_IIP_UNIT_ID_FLT;
	const ImIipStructEImIipUnitId dstUnitid = ImIipStruct_E_IM_IIP_UNIT_ID_SL6;
	const ImIipParamEImIipParamPortid srcPortid = ImIipParamEnum_E_IM_IIP_PARAM_PORTID_LD1;
	...
	const kuint32	 openResBitmask = ImIipStruct_E_IM_IIP_OPEN_RES_CACHE1;

	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "\n" ));

	priv->ercd = Im_IIP_Open_SWTRG( unitidBitmask, pixidBitmask, openResBitmask, CtImIip_D_CT_IM_IIP_OPEN_TIMEOUT_MSEC );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));
	if( priv->ercd != ImIipDefine_D_IM_IIP_OK ) {
		return priv->ercd;
	}
	...
	pixfmtTbl0 = gCtImIipPixfmttblBase;
	pixfmtTbl0.lineBytes.yG = D_IM_IIP_VGA_RAW12BIT_GLOBAL_WIDTH;
	pixfmtTbl0.lineBytes.cbB = 0;	// dummy
	pixfmtTbl0.lineBytes.crR = 0;	// dummy
	pixfmtTbl0.lineBytes.Alpha = 0;	// dummy
	pixfmtTbl0.addr.yG = D_IM_IIP_IMG_MEM_ADDR_0_RAW12BIT;
	pixfmtTbl0.addr.cbB = 0;		// dummy
	pixfmtTbl0.addr.crR = 0;		// dummy
	...
	pixfmtTbl0.pixFormat = ImIipStruct_E_IM_IIP_PFMT_BAYER;
	pixfmtTbl0.pixDepth = ImIipDefine_D_IM_IIP_PDEPTH_12BITS;

	pixfmtTbl1 = gCtImIipPixfmttblBase;
	pixfmtTbl1.lineBytes.yG = D_IM_IIP_VGA_RAW12BIT_GLOBAL_WIDTH;
	pixfmtTbl1.lineBytes.cbB = 0;	// dummy
	pixfmtTbl1.lineBytes.crR = 0;	// dummy
	pixfmtTbl1.lineBytes.Alpha = 0;	// dummy
	pixfmtTbl1.addr.yG = D_IM_IIP_IMG_MEM_ADDR_1_RAW12BIT;
	pixfmtTbl1.addr.cbB = 0;		// dummy
	pixfmtTbl1.addr.crR = 0;		// dummy
	...
	pixfmtTbl1.pixFormat = ImIipStruct_E_IM_IIP_PFMT_BAYER;
...
kint32 ct_im_iip_9_2_1( CtImIipFlt *self )
{
	...
	ImIipUnitCfg spfCfg;
	ImIipParam1Dl* onedUnitInf[2] = { &gCtImIipUnitParam1Dl0, &gCtImIipUnitParam1dl1 };
	...
	kuint32 waitFactorResult = 0;
	const kuint32	 waitFactor = ImIipDefine_D_IM_IIP_INT_FACTOR_AXIERR | ImIipDefine_D_IM_IIP_INT_FACTOR_SL6END;
	const kuint32 unitidBitmask = ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_LD1 | ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_LD2 |
			ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_BLEND0 | ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_FLT |
			ImIipDefine_D_IM_IIP_PARAM_PLDUNIT_SL6;
	const kuint32 pixidBitmask = ImIipStruct_E_IM_IIP_PIXID_9 | ImIipStruct_E_IM_IIP_PIXID_10 |
			ImIipStruct_E_IM_IIP_PIXID_11;
	const ImIipStructEImIipUnitId srcUnitid[2] = { ImIipStruct_E_IM_IIP_UNIT_ID_LD1,
			ImIipStruct_E_IM_IIP_UNIT_ID_LD2 };
	const ImIipStructEImIipUnitId filter1Unitid = ImIipStruct_E_IM_IIP_UNIT_ID_BLEND0;
	const ImIipStructEImIipUnitId filter2Unitid = ImIipStruct_E_IM_IIP_UNIT_ID_FLT;
	const ImIipStructEImIipUnitId dstUnitid = ImIipStruct_E_IM_IIP_UNIT_ID_SL6;
	...
	pixfmtTbl0 = gCtImIipPixfmttblBase;
	pixfmtTbl0.lineBytes.yG = CtImIip_D_IM_IIP_VGA_RGBA8888_GLOBAL_WIDTH;
	pixfmtTbl0.lineBytes.cbB = 0;	// dummy
	pixfmtTbl0.lineBytes.crR = 0;	// dummy
	pixfmtTbl0.lineBytes.Alpha = 0;	// dummy
	pixfmtTbl0.addr.yG = CtImIip_D_IM_IIP_IMG_MEM_ADDR_0_RGBA8888;
	pixfmtTbl0.addr.cbB = 0;		// dummy
	pixfmtTbl0.addr.crR = 0;		// dummy
	pixfmtTbl0.addr.Alpha = 0;	// dummy
	pixfmtTbl0.masterIfYG = ImIipDefine_D_IM_IIP_MASTER_IF1;
	...
	pixfmtTbl0.masterIfCrR = ImIipDefine_D_IM_IIP_MASTER_IF1;
	pixfmtTbl0.masterIfAlpha = ImIipDefine_D_IM_IIP_MASTER_IF1;
	pixfmtTbl0.frameType = ImIipStruct_E_IM_IIP_FTYPE_CHUNKY;	// RGBA8888
	pixfmtTbl0.pixFormat = ImIipStruct_E_IM_IIP_PFMT_YCC444;		// RGBA8888
	pixfmtTbl0.alphaDepth = ImIipStruct_E_IM_IIP_ADEPTH_8BITS;	// RGBA8888
	pixfmtTbl0.alpha = ImIipDefine_D_IM_IIP_ALPHA_TRUE;			// RGBA8888

	pixfmtTbl1 = gCtImIipPixfmttblBase;
	pixfmtTbl1.lineBytes.yG = CtImIip_D_IM_IIP_VGA_RGBA8888_GLOBAL_WIDTH;
	pixfmtTbl1.lineBytes.cbB = 0;	// dummy
	pixfmtTbl1.lineBytes.crR = 0;	// dummy
	pixfmtTbl1.lineBytes.Alpha = 0;	// dummy
	pixfmtTbl1.addr.yG = CtImIip_D_IM_IIP_IMG_MEM_ADDR_4_RGBA8888;
	pixfmtTbl1.addr.cbB = 0;		// dummy
	pixfmtTbl1.addr.crR = 0;		// dummy
	pixfmtTbl1.addr.Alpha = 0;	// dummy
	pixfmtTbl1.masterIfYG = ImIipDefine_D_IM_IIP_MASTER_IF1;
	...
	pixfmtTbl1.masterIfCrR = ImIipDefine_D_IM_IIP_MASTER_IF1;
	pixfmtTbl1.masterIfAlpha = ImIipDefine_D_IM_IIP_MASTER_IF1;
	pixfmtTbl1.frameType = ImIipStruct_E_IM_IIP_FTYPE_CHUNKY;	// RGBA8888
	pixfmtTbl1.pixFormat = ImIipStruct_E_IM_IIP_PFMT_YCC444;		// RGBA8888
	pixfmtTbl1.alphaDepth = ImIipStruct_E_IM_IIP_ADEPTH_8BITS;	// RGBA8888
	pixfmtTbl1.alpha = ImIipDefine_D_IM_IIP_ALPHA_TRUE;			// RGBA8888

	pixfmtTbl2 = gCtImIipPixfmttblBase;
	pixfmtTbl2.lineBytes.yG = CtImIip_D_IM_IIP_VGA_RGBA8888_GLOBAL_WIDTH;
	pixfmtTbl2.lineBytes.cbB = 0;	// dummy
	pixfmtTbl2.lineBytes.crR = 0;	// dummy
	pixfmtTbl2.lineBytes.Alpha = 0;	// dummy
	pixfmtTbl2.addr.yG = CtImIip_D_IM_IIP_IMG_MEM_ADDR_1_RGBA8888;
	pixfmtTbl2.addr.cbB = 0;		// dummy
	pixfmtTbl2.addr.crR = 0;		// dummy
	...
	pixfmtTbl2.frameType = ImIipStruct_E_IM_IIP_FTYPE_CHUNKY;	// RGBA8888
	pixfmtTbl2.pixFormat = ImIipStruct_E_IM_IIP_PFMT_YCC444;		// RGBA8888
	pixfmtTbl2.alphaDepth = ImIipStruct_E_IM_IIP_ADEPTH_8BITS;	// RGBA8888
	...
	*onedUnitInf[0] = gCtImIipParam1DlBase;
	...
	onedCfg[0].unitCtrl = ImIipDefine_D_IM_IIP_HW_CTRL_SWTRG;
	onedCfg[0].chainEnable = ImIipDefine_D_IM_IIP_PLDUNIT_CHAIN_DISABLE;
	...
	*onedUnitInf[1] = gCtImIipParam1DlBase;
	...
	onedCfg[1].unitCtrl = ImIipDefine_D_IM_IIP_HW_CTRL_SWTRG;
	onedCfg[1].chainEnable = ImIipDefine_D_IM_IIP_PLDUNIT_CHAIN_DISABLE;
	...
	*blendUnitInf = gCtImIipParamBlendBase;
	...
	blendCfg.unitCtrl = ImIipDefine_D_IM_IIP_HW_CTRL_SWTRG;
	blendCfg.chainEnable = ImIipDefine_D_IM_IIP_PLDUNIT_CHAIN_DISABLE;
	...
	*slUnitInf = gCtImIipParamStsBase;
	...
	priv->ercd = Im_IIP_Ctrl_PIXFMTTBL( srcPixid[0], &pixfmtTbl0 );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_PIXFMTTBL( srcPixid[1], &pixfmtTbl1 );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_PIXFMTTBL( dstPixid, &pixfmtTbl2 );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_SWTRG_Unit( srcUnitid[0], &onedCfg[0] );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_SWTRG_Unit( srcUnitid[1], &onedCfg[1] );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	priv->ercd = Im_IIP_Ctrl_SWTRG_Unit( filter1Unitid, &blendCfg );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));
	...
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "Start3\n" ));
	priv->ercd = Im_IIP_Start_SWTRG( srcUnitid[0], ImIipDefine_D_IM_IIP_SWTRG_ON );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));

	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "Start4\n" ));
	priv->ercd = Im_IIP_Start_SWTRG( srcUnitid[1], ImIipDefine_D_IM_IIP_SWTRG_ON );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));
...
kint32 ct_im_iip_9_3_1( CtImIipFlt *self )
{
	...
	const kuint32	 pixidBitmask = ImIipStruct_E_IM_IIP_PIXID_10 | ImIipStruct_E_IM_IIP_PIXID_11;
	const ImIipStructEImIipUnitId srcUnitid = ImIipStruct_E_IM_IIP_UNIT_ID_FLT;
	const ImIipStructEImIipUnitId dstUnitid = ImIipStruct_E_IM_IIP_UNIT_ID_SL6;
	...
	pixfmtTbl0 = gCtImIipPixfmttblBase;
	pixfmtTbl0.lineBytes.yG = CtImIip_D_IM_IIP_VGA_RGBA5551_GLOBAL_WIDTH;
	pixfmtTbl0.lineBytes.cbB = 0;	// dummy
	pixfmtTbl0.lineBytes.crR = 0;	// dummy
	pixfmtTbl0.lineBytes.Alpha = 0;	// dummy
	pixfmtTbl0.addr.yG = CtImIip_D_IM_IIP_IMG_MEM_ADDR_0_RGBA5551;
	pixfmtTbl0.addr.cbB = 0;		// dummy
	pixfmtTbl0.addr.crR = 0;		// dummy
	pixfmtTbl0.addr.Alpha = 0;	// dummy
	pixfmtTbl0.masterIfYG = ImIipDefine_D_IM_IIP_MASTER_IF1;
	...
	pixfmtTbl0.masterIfCrR = ImIipDefine_D_IM_IIP_MASTER_IF1;
	pixfmtTbl0.masterIfAlpha = ImIipDefine_D_IM_IIP_MASTER_IF1;
	pixfmtTbl0.pixFormat = ImIipStruct_E_IM_IIP_PFMT_RGBA5551;
	pixfmtTbl0.alpha = ImIipDefine_D_IM_IIP_ALPHA_TRUE;

	pixfmtTbl1 = gCtImIipPixfmttblBase;
	pixfmtTbl1.lineBytes.yG = CtImIip_D_IM_IIP_VGA_RGBA5551_GLOBAL_WIDTH;
	pixfmtTbl1.lineBytes.cbB = 0;	// dummy
	pixfmtTbl1.lineBytes.crR = 0;	// dummy
	pixfmtTbl1.lineBytes.Alpha = 0;	// dummy
	pixfmtTbl1.addr.yG = CtImIip_D_IM_IIP_IMG_MEM_ADDR_1_RGBA5551;
	pixfmtTbl1.addr.cbB = 0;		// dummy
	pixfmtTbl1.addr.crR = 0;		// dummy
	pixfmtTbl1.addr.Alpha = 0;	// dummy
	pixfmtTbl1.masterIfYG = ImIipDefine_D_IM_IIP_MASTER_IF1;
	...
	pixfmtTbl1.masterIfCrR = ImIipDefine_D_IM_IIP_MASTER_IF1;
	pixfmtTbl1.masterIfAlpha = ImIipDefine_D_IM_IIP_MASTER_IF1;
	pixfmtTbl1.pixFormat = ImIipStruct_E_IM_IIP_PFMT_RGBA5551;
	...
	*slUnitInf = gCtImIipParamStsBase;
	...
	priv->ercd = Im_IIP_Ctrl_SWTRG_Unit( srcUnitid, &spfCfg );
	CtImIipFlt_DDIM_PRINT(( CtImIipFlt_D_IM_IIP_FUNC_NAME "priv->ercd = 0x%x\n", priv->ercd ));
