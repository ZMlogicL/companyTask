...
K_TYPE_DEFINE_WITH_PRIVATE(ShdrTest23, shdr_test2_3)
#define SHDR_TEST2_3_GET_PRIVATE(o)(K_OBJECT_GET_PRIVATE ((o), ShdrTest23Private, SHDR_TYPE_TEST2_3))


struct _ShdrTest23Private
{
 ...
 * IMPL
 */
static void shdr_test2_3_constructor(ShdrTest23 *self)
{
//	ShdrTest23Private *priv = SHDR_TEST2_3_GET_PRIVATE(self);
}

static void shdr_test2_3_destructor(ShdrTest23 *self)
{
//	ShdrTest23Private *priv = SHDR_TEST2_3_GET_PRIVATE(self);
}
...
{
	Ddim_Print(("ct_im_shdr_tset2_3_lineint_callback\n"));
}
...
{
	Ddim_Print(("ct_im_shdr_tset2_3_callback\n"));
}

ShdrTest23* shdr_test2_3_get(void)
{
	static ShdrTest23* self = NULL;

	if (!self) {
		self = k_object_new_with_private(SHDR_TYPE_TEST2_3, sizeof(ShdrTest23Private));
	}
