...
#define CtDdUdc_D_CH0_AIN		(DdTop_GPIO_PF2)
#define CtDdUdc_D_CH0_BIN		(DdTop_GPIO_PF0)
#define CtDdUdc_D_CH0_ZIN		(DdTop_GPIO_PE1)
#define CtDdUdc_D_CH1_AIN		(DdTop_GPIO_PF1)
#define CtDdUdc_D_CH1_BIN		(DdTop_GPIO_P87)
#define CtDdUdc_D_CH1_ZIN		(DdTop_GPIO_PE3)
#define CtDdUdc_D_CH2_AIN		(DdTop_GPIO_PE0)
#define CtDdUdc_D_CH2_BIN		(DdTop_GPIO_PE1)
#define CtDdUdc_D_CH3_AIN		(DdTop_GPIO_PE2)
#define CtDdUdc_D_CH3_BIN		(DdTop_GPIO_PE3)
#define CtDdUdc_D_CH4_AIN		(DdTop_GPIO_PE4)
#define CtDdUdc_D_CH4_BIN		(DdTop_GPIO_PE5)
#define CtDdUdc_D_CH5_AIN		(DdTop_GPIO_PM0)
#define CtDdUdc_D_CH5_BIN		(DdTop_GPIO_PP3)
...
typedef enum {
	CtDdUdc_TRG_KIND_AIN = 0,	// AIN
	CtDdUdc_TRG_KIND_BIN,		// BIN
	CtDdUdc_TRG_KIND_ZIN,		// ZIN
	CtDdUdc_TRG_KIND_END		// End of enum
} CtDdUdcTrgKind;

// Kind of general-purpose port register
typedef enum {
	CtDdUdc_PORT_KIND_PDR = 0,	// PDR
	CtDdUdc_PORT_KIND_DDR,		// DDR
	CtDdUdc_PORT_KIND_EPCR,		// EPCR
	CtDdUdc_PORT_KIND_END		// End of enum
} CtDdUdcPortKind;
