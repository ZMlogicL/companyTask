 ...
 * G_DEFINE_语句
 * */
G_DEFINE_TYPE (CtImDisp3a, ct_im_disp3a, G_TYPE_OBJECT);

/*
 * 以下开始宏定义
 * */
#define CT_IM_DISP3A_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), CT_TYPE_IM_DISP3A, CtImDisp3aPrivate))
...
static void dumpRegGrch(CtImDisp3a *self, E_IM_DISP_SEL block, gint32 i);
static void outputByte9LccTable(U_IM_DISP_LCC table[3]);
static void outputShortTable(gushort table[], gint32 size);

/*
 * IMPL
 * */
static void ct_im_disp3a_class_init(CtImDisp3aClass *klass)
{
	GObjectClass *object_class = G_OBJECT_CLASS (klass);
	object_class->dispose = dispose_od;
	object_class->finalize = finalize_od;
	g_type_class_add_private(klass, sizeof(CtImDisp3aPrivate));
}

static void ct_im_disp3a_init(CtImDisp3a *self)
{
...
static void dispose_od(GObject *object)
{
//	CtImDisp3a *self = CT_IM_DISP3A(object);
//	CtImDisp3aPrivate *priv = CT_IM_DISP3A_GET_PRIVATE(self);
	/*释放创建的对象1*/
//	if (priv->objectMine) {
...
//	}
	G_OBJECT_CLASS (ct_im_disp3a_parent_class)->dispose(object);
}
...
//		self->name =NULL;
//	}
	G_OBJECT_CLASS (ct_im_disp3a_parent_class)->finalize(object);
}
...
static void dumpRegLch(CtImDisp3a *self, E_IM_DISP_SEL block)
{
	...
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.RPGEN   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.RPGEN.word));
	Ddim_Print(("IO_DISP.MAIN[%d].LCH.LRST      = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].LCH.LRST.word));
	...
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].LCH.LYSA[0].word), 4);
	Ddim_Print(("IO_DISP.MAIN[%d].LCH.LCSA      = \n", block));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].LCH.LCSA[0].word), 4);
	...
	Ddim_Print(("IO_DISP.MAIN[%d].LCH.LRSZ0     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].LCH.LRSZ0.word));
	Ddim_Print(("IO_DISP.MAIN[%d].LCH.LRSZ1     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].LCH.LRSZ1.word));
	Ddim_Print(("IO_DISP.MAIN[%d].LCH.LRSZ2     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].LCH.LRSZ2.word));
	Ddim_Print(("IO_DISP.MAIN[%d].LCH.LRSZ3     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].LCH.LRSZ3.word));
...
static void dumpRegDcore(CtImDisp3a *self, E_IM_DISP_SEL block)
{
	...
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.TOCTL    = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.TOCTL.word));
	...
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.INTF     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.INTF.word));
	...
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.RPGCTL   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.RPGCTL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.RPGEN    = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.RPGEN.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.POLSEL   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.POLSEL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.TSL      = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.TSL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.VCYC     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.VCYC.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.HCYC     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.HCYC.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.OVPW     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.OVPW.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.HPW      = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.HPW.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.VBLK     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.VBLK.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.HBLK     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.HBLK.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.VDLY     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.VDLY.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.HDLY     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.HDLY.word));
	...
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.VRFCTL   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.VRFCTL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.HRFCTL   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.HRFCTL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.HABLK    = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.HABLK.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.DOMD     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.DOMD.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.FDOEN    = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.FDOEN.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.FODATA   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.FODATA.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.BLANKDT1  = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.BLANKDT.BLANKDT1.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.BLANKDT2  = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.BLANKDT.BLANKDT2.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.CLBHSIZE = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.CLBHSIZE.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.CLBDT      = \n", block));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].DCORE.CLBDT[0]), 16);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.BLDCTL   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.BLDCTL.word));
	...
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.DOCTL0   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.DOCTL0.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.DOCTL1   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.DOCTL1.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.DOCTL2   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.DOCTL2.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.TRSCODE0 = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.TRSCODE0.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.TRSCODE1 = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.TRSCODE1.word));
	...
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GHDSTA   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.GHDSTA.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GVDSTA   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.GVDSTA.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GLENGTH  = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.GLENGTH.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GWIDTH   = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.GWIDTH.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GITVL    = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.GITVL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GNUM     = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.GNUM.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GDCTL    = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.GDCTL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GDISPEN  = %08X\n",
			block, (guint32)IO_DISP.MAIN[block].DCORE.GDISPEN.word));
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.FFDSTA   = \n", block));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].DCORE.FFDSTA[0]), 42);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.FFSIZE   = \n", block));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].DCORE.FFSIZE[0]), 42);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.FFWIDTH  = \n", block));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].DCORE.FFWIDTH[0]), 42);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.FFCLR    = \n", block));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].DCORE.FFCLR[0].word), 42);
...
static void dumpRegGrch(CtImDisp3a *self, E_IM_DISP_SEL block, gint32 i)
{
	...
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRRST      = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRRST.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRTRG      = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRTRG.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRRPGCTL   = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRRPGCTL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRIDT      = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRIDT.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRTISIZE   = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRTISIZE.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRTDSTA    = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRTDSTA.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRIPO      = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRIPO.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRSCCTL    = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRSCCTL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRISIZE    =", block, i));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRISIZE[0]), 10);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRSA0    =", block, i));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRSA0[0]), 4);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRSA     =", block, i));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRSA[0]), 9);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRASA    =", block, i));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRASA[0]), 10);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRHGA    =", block, i));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRHGA[0]), 10);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRAHGA   =", block, i));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRAHGA[0]), 10);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRDSTA   =", block, i));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRDSTA[0]), 10);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRAREN   = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRAREN.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRBSL    = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRBSL.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRBLINK  =", block, i));
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRBLINK.word[0]), 5);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRBINIT  = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRBINIT.word));
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRBITRG  = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRBITRG.word));
	...
	ct_im_disp3a_output_word_table((guint32*)(&IO_DISP.MAIN[block].GRCH[i].GRY2R[0]), 3);
	Ddim_Print(("IO_DISP.MAIN[%d].GRCH[%d].GRALP    = %08X\n",
			block, i, (guint32)IO_DISP.MAIN[block].GRCH[i].GRALP.word));
	ct_im_disp3_pclk_counter_off(priv->pImDispPclkCounter);
}
...
void ct_im_disp3a_dump_reg_dcore_gamma(CtImDisp3a *self, E_IM_DISP_SEL block)
{
	...
	outputShortTable((gushort*)(&IO_DISP_TBL.MAIN[block].DCORE.GTBLA.GTBLR), 33);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GTBLA.GTBLB      = \n", block));
	outputShortTable((gushort*)(&IO_DISP_TBL.MAIN[block].DCORE.GTBLA.GTBLG), 33);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GTBLA.GTBLB      = \n", block));
	outputShortTable((gushort*)(&IO_DISP_TBL.MAIN[block].DCORE.GTBLA.GTBLB), 33);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GTBLB.GTBLR      = \n", block));
	outputShortTable((gushort*)(&IO_DISP_TBL.MAIN[block].DCORE.GTBLB.GTBLR), 33);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GTBLB.GTBLG      = \n", block));
	outputShortTable((gushort*)(&IO_DISP_TBL.MAIN[block].DCORE.GTBLB.GTBLG), 33);
	Ddim_Print(("IO_DISP.MAIN[%d].DCORE.GTBLB.GTBLB      = \n", block));
	outputShortTable((gushort*)(&IO_DISP_TBL.MAIN[block].DCORE.GTBLB.GTBLB), 33);
...
void ct_im_disp3a_print_param_ctrl_osd_layer(T_IM_DISP_CTRL_OSD_LAYER osd)
{
	...
	Ddim_Print(("grisize:0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grisize[0].word, (guint32)osd.grisize[1].word,
			(guint32)osd.grisize[2].word, (guint32)osd.grisize[3].word,
			(guint32)osd.grisize[4].word));
	Ddim_Print(("       :0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grisize[5].word, (guint32)osd.grisize[6].word,
			(guint32)osd.grisize[7].word, (guint32)osd.grisize[8].word, (guint32)osd.grisize[9].word));
	Ddim_Print(("grsa0  :0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grsa0[0],	(guint32)osd.grsa0[1], 	(guint32)osd.grsa0[2], (guint32)osd.grsa0[3]));
	Ddim_Print(("grsa   :0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grsa[0], (guint32)osd.grsa[1], (guint32)osd.grsa[2],
			(guint32)osd.grsa[3], (guint32)osd.grsa[4]));
	Ddim_Print(("       :0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grsa[5], (guint32)osd.grsa[6], (guint32)osd.grsa[7], (guint32)osd.grsa[8]));
	Ddim_Print(("grhga  :0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grhga[0], (guint32)osd.grhga[1], (guint32)osd.grhga[2],
			(guint32)osd.grhga[3], (guint32)osd.grhga[4]));
	Ddim_Print(("       :0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grhga[5], (guint32)osd.grhga[6], (guint32)osd.grhga[7],
			(guint32)osd.grhga[8], (guint32)osd.grhga[9]));
	Ddim_Print(("grahga :0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grahga[0], (guint32)osd.grahga[1], (guint32)osd.grahga[2],
			(guint32)osd.grahga[3], (guint32)osd.grahga[4]));
	Ddim_Print(("       :0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grahga[5], (guint32)osd.grahga[6], (guint32)osd.grahga[7],
			(guint32)osd.grahga[8], (guint32)osd.grahga[9]));
	Ddim_Print(("grdsta :0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grdsta[0].word, (guint32)osd.grdsta[1].word,
			(guint32)osd.grdsta[2].word, (guint32)osd.grdsta[3].word, (guint32)osd.grdsta[4].word));
	Ddim_Print(("       :0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grdsta[5].word, (guint32)osd.grdsta[6].word,
			(guint32)osd.grdsta[7].word, (guint32)osd.grdsta[8].word, (guint32)osd.grdsta[9].word));
	Ddim_Print(("graren :0x%08X\n",	(guint32)osd.graren));
	Ddim_Print(("grbsl  :0x%08X\n",	(guint32)osd.grbsl));
	Ddim_Print(("grblink:0x%08X,  0x%08X,  0x%08X,  0x%08X,  0x%08X\n",
			(guint32)osd.grblink.word[0], (guint32)osd.grblink.word[1],
			(guint32)osd.grblink.word[2], (guint32)osd.grblink.word[3], (guint32)osd.grblink.word[4]));
	Ddim_Print(("grbinit:0x%08X\n", (guint32)osd.grbinit));
	Ddim_Print(("grbitrg:0x%08X\n", (guint32)osd.grbitrg));
	Ddim_Print(("grrsz0 :0x%08X\n",	(guint32)osd.grrsz0));
	Ddim_Print(("grrsz1 :0x%08X\n",	(guint32)osd.grrsz1.word));
	Ddim_Print(("grrsz2 :0x%08X\n",	(guint32)osd.grrsz2.word));
	Ddim_Print(("grrsz3 :0x%08X\n",	(guint32)osd.grrsz3.word));
	Ddim_Print(("gry2r  :0x%08X,  0x%08X,  0x%08X\n",
			(gint32)osd.gry2r[0].word, (gint32)osd.gry2r[1].word, (gint32)osd.gry2r[2].word));
...
void ct_im_disp3a_output_dcore_gamma(const T_IM_DISP_GAMMA_TBL_OUT gammaTbl)
{
	if(gammaTbl.r_data){
		Ddim_Print(("--- r_data ---\n"));
		outputShortTable((gushort*)gammaTbl.r_data, 33);
	}
	if(gammaTbl.g_data){
		Ddim_Print(("--- g_data ---\n"));
		outputShortTable((gushort*)gammaTbl.g_data, 33);
	}
	if(gammaTbl.b_data){
		Ddim_Print(("--- b_data ---\n"));
		outputShortTable((gushort*)gammaTbl.b_data, 33);
	}
}
...
void ct_im_disp3a_get_ctrl_main_layer(BYTE getDataType, E_IM_DISP_SEL block)
{
	...
	gint32 error = Im_DISP_Get_Ctrl_Main_Layer(block, pCtrlTrgLimit, pCtrl);
	if(error != D_DDIM_OK){
	...
	if(pCtrl){
		...
		Ddim_Print(("lidt0        = %08X\n",(guint32)ctrl.lidt.word[0]));
		Ddim_Print(("lidt1        = %08X\n",(guint32)ctrl.lidt.word[1]));
		Ddim_Print(("lisize       = %08X\n",(guint32)ctrl.lisize.word));
		for(i = 0; i < 4; i++){
			Ddim_Print(("laddr[%d] = %08X,%08X\n", i,
					(guint32)ctrl.laddr[i].y_addr, (guint32)ctrl.laddr[i].c_addr));
		}
		...
		Ddim_Print(("warning.lbost   = %08X\n",(guint32)ctrl.warning.lbost));
		Ddim_Print(("lbltmr = %08X\n",(guint32)ctrl.lbltmr.word));
		Ddim_Print(("zebra.lzbwid   = %08X\n",(guint32)ctrl.zebra.lzbwid.word));
		Ddim_Print(("zebra.lzbv     = %08X\n",(guint32)ctrl.zebra.lzbv.word));
		Ddim_Print(("zebra.lzbpt    = %08X\n",(guint32)ctrl.zebra.lzbpt.word));
		Ddim_Print(("--- ly2r ---\n"));
		...
		Ddim_Print(("lgmmd    = %08X\n",(guint32)ctrl.lgmmd.word));
		Ddim_Print(("lalp     = %08X\n",(guint32)ctrl.lalp.word));
		Ddim_Print(("ldsta    = %08X\n",(guint32)ctrl.ldsta.word));
		Ddim_Print(("lrevdisp = %08X\n",(guint32)ctrl.lrevdisp.word));
	}
}
...
{
	CtImDisp3a *self = (CtImDisp3a *) g_object_new(CT_TYPE_IM_DISP3A, NULL);
	CtImDisp3aPrivate *priv = self->privCtImDisp3a;
