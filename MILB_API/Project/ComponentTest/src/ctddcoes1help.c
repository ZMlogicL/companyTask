...
#include "ctddcoes1help.h"

K_TYPE_DEFINE_WITH_PRIVATE(CtDdCoes1Help, ct_dd_coes1_help);
#define CT_DD_COES1_HELP_GET_PRIVATE(o)(K_OBJECT_GET_PRIVATE ((o),CtDdCoes1HelpPrivate,CT_TYPE_DD_COES1_HELP))

struct _CtDdCoes1HelpPrivate
{
	kint a;
};
/****************
* DECLS
*/
static void 			ct_dd_coes1_help_constructor(CtDdCoes1Help *self);
static void 			ct_dd_coes1_help_destructor(CtDdCoes1Help *self) ;
/****************
* IMPL
*/
static void ct_dd_coes1_help_constructor(CtDdCoes1Help *self) 
{
//	CtDdCoes1HelpPrivate *priv = CT_DD_COES1_HELP_GET_PRIVATE(self);
}
...
{
    CtDdCoes1Help *self = k_object_new_with_private(CT_TYPE_DD_COES1_HELP, sizeof(CtDdCoes1HelpPrivate));
    return self;
}
