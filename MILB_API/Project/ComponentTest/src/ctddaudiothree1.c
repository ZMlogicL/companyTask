...
G_DEFINE_TYPE(CtDdAudioThree1, ct_dd_audio_three1, G_TYPE_OBJECT);
#define CT_DD_AUDIO_THREE1_GET_PRIVATE(o)(G_TYPE_INSTANCE_GET_PRIVATE ((o),CT_TYPE_DD_AUDIO_THREE1, CtDdAudioThree1Private))
...
*DECLS
*/
static void 	ct_dd_audio_three1_class_init(CtDdAudioThree1Class *klass);
static void 	ct_dd_audio_three1_init(CtDdAudioThree1 *self);
...
static void ct_dd_audio_three1_class_init(CtDdAudioThree1Class *klass)
{
	...
	g_type_class_add_private(klass, sizeof(CtDdAudioThree1Private));
}

static void ct_dd_audio_three1_init(CtDdAudioThree1 *self)
{
	CtDdAudioThree1Private *priv = CT_DD_AUDIO_THREE1_GET_PRIVATE(self);
}

static void dispose_od(GObject *object)
{
	CtDdAudioThree1 *self = (CtDdAudioThree1*)object;
	CtDdAudioThree1Private *priv = CT_DD_AUDIO_THREE1_GET_PRIVATE(self);
}
...
{
    CtDdAudioThree1 *self = g_object_new(CT_TYPE_DD_AUDIO_THREE1, NULL);
    if(!temp)
    {
         *temp = (kpointer)self;
    }
