...
K_TYPE_DEFINE_DERIVED_WITH_PRIVATE(CtImDisp1, ct_im_disp1, IM_TYPE_DISP1_PARENT)
#define CT_IM_DISP1_GET_PRIVATE(o) (K_OBJECT_GET_PRIVATE ((o), CtImDisp1Private, CT_TYPE_IM_DISP1))
...
static kboolean imDisp1DoPctest_od(ImDisp1Parent *parent, kint32 *pSeqNo);
#endif /*CtImDisp_CO_DEBUG_DISP*/

/*
 * IMPL
 * */
static void ct_im_disp1_constructor(CtImDisp1 *self)
{
...
static void ct_im_disp1_destructor(CtImDisp1 *self)
{
}
...
{
	CtImDisp1 *self = (CtImDisp1 *) k_object_new_with_private(CT_TYPE_IM_DISP1,sizeof(CtImDisp1Private));
