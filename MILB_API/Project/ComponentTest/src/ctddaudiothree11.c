...
static void 	ctDdAudioDmaIntHandler105Out_cb( void );
static void 	ctDdAudioDmaIntHandler106In_cb( void );
static void 	ctDdAudioDmaIntHandler106Out_cb( void );
static void 	ctDdAudioDmaIntHandler107In_cb( void );
static void 	ctDdAudioDmaIntHandler107Out_cb( void );
static void 	ctDdAudioDmaIntHandler108In_cb( void );
static void 	ctDdAudioDmaIntHandler108Out_cb( void );
/*
 * IMPL
 */
static void ct_dd_audio_three11_class_init(CtDdAudioThree11Class *klass)
...
static void ctDdAudioDmaIntHandler104In_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Input_Audio_Async( 0,
			 ...
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler104In_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler104In_cb\n"));
}
...
static void ctDdAudioDmaIntHandler104Out_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_out(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Output_Audio_Async(2,
			 ...
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler104Out_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler104Out_cb\n"));
}
...
static void ctDdAudioDmaIntHandler105In_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Input_Audio_Async( 0,
			 ...
			 CtDdAudio_CT_DD_Audio_WORK_AREA2+(800 * 2 * ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new())),
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler105In_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler105In_cb\n"));
}
...
static void ctDdAudioDmaIntHandler105Out_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_out(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Output_Audio_Async(2,
			 ...
			 Dd_Audio_Get_Addr_Reg_AUODLR(ch),
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler105Out_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler105Out_cb\n"));
}
...
static void ctDdAudioDmaIntHandler106In_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Input_Audio_Async( 0,
			 ...
			 CtDdAudio_CT_DD_Audio_WORK_AREA2+(800 * 2 * ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new())),
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler106In_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler106In_cb\n"));
}
...
static void ctDdAudioDmaIntHandler106Out_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_out(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Output_Audio_Async(2,
			 ...
			 Dd_Audio_Get_Addr_Reg_AUODLR(ch),
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler106Out_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler106Out_cb\n"));
}
...
static void ctDdAudioDmaIntHandler107In_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Input_Audio_Async( 0,
			 ...
			 CtDdAudio_CT_DD_Audio_WORK_AREA2+(800 * 2 * ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new())),
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler107In_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler107In_cb\n"));
}
...
static void ctDdAudioDmaIntHandler107Out_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_out(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Output_Audio_Async(2,
			 ...
			 Dd_Audio_Get_Addr_Reg_AUODLR(ch),
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler107Out_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler107Out_cb\n"));
}
...
static void ctDdAudioDmaIntHandler108In_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Input_Audio_Async( 0,
			 ...
			 CtDdAudio_CT_DD_Audio_WORK_AREA2+(800 * 2 * ct_dd_audio_get_dma_int_cnt_in(ct_dd_audio_variable_new())),
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler108In_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler108In_cb\n"));
}
...
static void ctDdAudioDmaIntHandler108Out_cb( void )
{
	...
	if(ct_dd_audio_get_dma_int_cnt_out(ct_dd_audio_variable_new()) < 10) {
		Dd_HDMAC0_Output_Audio_Async(2,
			 ...
			 Dd_Audio_Get_Addr_Reg_AUODLR(ch),
			 (800 * 2),
			 (VP_CALLBACK)ctDdAudioDmaIntHandler108Out_cb);
	}

	Ddim_Print(("ctDdAudioDmaIntHandler108Out_cb\n"));
}
/*
 * PUBLIC
 */
void ct_dd_audio_three11_104(CtDdAudioThree11 *self)
{
    ...
    ct_dd_audio_test_fin(testFin, "> audio 104 : Record 32FS Just-Left test");
}
...
void ct_dd_audio_three11_105(CtDdAudioThree11 *self)
{
	...
	CtDdAudio* testFin = ct_dd_audio_new(NULL, ch);
    ct_dd_audio_test_fin(testFin, "> audio 105 : Record 32FS Just-Right test");
}
...
void ct_dd_audio_three11_106(CtDdAudioThree11 *self)
{
	...
	CtDdAudio* testFin = ct_dd_audio_new(NULL, ch);
    ct_dd_audio_test_fin(testFin, "> audio 106 : Record 32FS I2S-Format test");
}
...
void ct_dd_audio_three11_107(CtDdAudioThree11 *self)
{
	...
	CtDdAudio* testFin = ct_dd_audio_new(NULL, ch);
    ct_dd_audio_test_fin(testFin, "> audio 107 : Record 48FS Just-Left test");
}
...
void ct_dd_audio_three11_108(CtDdAudioThree11 *self)
{
	...
	CtDdAudio* testFin = ct_dd_audio_new(NULL, ch);
    ct_dd_audio_test_fin(testFin, "> audio 108 : Record 48FS Just-Right test");
}
