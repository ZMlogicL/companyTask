...
@param[in]		src_full_tbl			: Pointer of diff Table data array (Type of kuint16, array number is ImR2yCtrl_TABLE_MAX_GAMMA)
@param[in]		src_diff_tbl			: Pointer of full Table data array (Type of ULLONG, array number is ImR2yCtrl_TABLE_MAX_GAMMA)
@retval			D_DDIM_OK				: success
@retval			ImR2yUtils_PARAM_ERROR	: parameter error.
@retval			ImR2yUtils_MACRO_BUSY		: Macro is running. Do not update Gamma table.
*/
...
@param[in]		pipeNo					: Image pipe no(pipe1/pipe2/pipe12).
@param[in]		src_tbl					: Pointer of Table data (Type of kuint16, Maximum array number is ImR2yCtrl_TABLE_MAX_EDGE_SCALE_HI)
...
@retval			D_DDIM_OK				: success.
@retval			ImR2yUtils_PARAM_ERROR	: parameter error.
@retval			ImR2yUtils_MACRO_BUSY		: Macro is running. Do not update High Edge enhancement table.
*/
...
@param[in]		pipeNo					: Image pipe no(pipe1/pipe2/pipe12).
@param[in]		src_tbl					: Pointer of Table data (Type of kuint16, Maximum array number is ImR2yCtrl_TABLE_MAX_EDGE_TC_HI)
@param[in]		write_ofs_num			: write offset num of table constituent(kuint16 data num, must set multiple of 2).
@param[in]		array_num				: num of table constituent(kuint16 data num, must set multiple of 2).
@retval			D_DDIM_OK				: success.
@retval			ImR2yUtils_PARAM_ERROR	: parameter errore.
@retval			ImR2yUtils_MACRO_BUSY		: Macro is running. Do not update High Edge enhancement table.
*/
...
@retval			D_DDIM_OK				: success.
@retval			ImR2yUtils_PARAM_ERROR	: parameter error.
@retval			ImR2yUtils_MACRO_BUSY		: Macro is running. Do not update Medium Edge enhancement table.
*/
...
@param[in]		pipeNo					: Image pipe no(pipe1/pipe2/pipe12).
@param[in]		src_tbl					: Pointer of Table data (Type of kuint16, Maximum array number is ImR2yCtrl_TABLE_MAX_EDGE_SCALE_LO)
@param[in]		write_ofs_num			: write offset num of table constituent(kuint16 data num, must set multiple of 2).
@param[in]		array_num				: num of table constituent(kuint16 data num, must set multiple of 2).
@retval			D_DDIM_OK				: success.
@retval			ImR2yUtils_PARAM_ERROR	: parameter errore.
@retval			ImR2yUtils_MACRO_BUSY		: Macro is running. Do not update Low Edge enhancement table.
*/
...
@param[in]		pipeNo					: Image pipe no(pipe1/pipe2/pipe12).
@param[in]		src_tbl					: Pointer of Table data (Type of kuint16, Maximum array number is ImR2yCtrl_TABLE_MAX_EDGE_TC_LO)
@param[in]		write_ofs_num			: write offset num of table constituent(kuint16 data num, must set multiple of 2).
@param[in]		array_num				: num of table constituent(kuint16 data num, must set multiple of 2).
@retval			D_DDIM_OK				: success.
@retval			ImR2yUtils_PARAM_ERROR	: parameter error.
...
Set Map Scale Table
@param[in]		pipeNo					: Image pipe no(pipe1/pipe2/pipe12).
@param[in]		src_tbl					: Pointer of Table data (Type of kuint16, Maximum array number is ImR2yCtrl_TABLE_MAX_MAPSCL)
@param[in]		write_ofs_num			: write offset num of table constituent(kuint16 data num, must set multiple of 2).
@param[in]		array_num				: num of table constituent(kuint16 data num, must set multiple of 2).
@retval			D_DDIM_OK				: success.
@retval			ImR2yUtils_PARAM_ERROR	: parameter error.
