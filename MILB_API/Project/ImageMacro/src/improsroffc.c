...
static const TimproRdmaFfcAddr S_G_IM_PRO_FFC_Addr[ImproBase_E_IM_PRO_UNIT_NUM_MAX] = {
	{
...
static const UINT32	gIM_PRO_FFC_Status_Tbl[ImproBase_E_IM_PRO_UNIT_NUM_MAX] = {
