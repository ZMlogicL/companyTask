...
*/
INT32 impro_sensldiv_start( E_IM_PRO_LDIV_CH ch )
{
	// Dd_Top_Start_Clock
...
*/
INT32 impro_sensldiv_stop( E_IM_PRO_LDIV_CH ch, UCHAR force )
{
	// Dd_Top_Start_Clock
	im_pro_on_pclk( E_IM_PRO_UNIT_NUM_1, E_IM_PRO_CLK_BLOCK_TYPE_SEN );
	if (force == 0){
...
*/
INT32 impro_sensldiv_ctrl( E_IM_PRO_LDIV_CH ch, TimproLdivCtrl* ldivCtrl )
{
...
@retval		D_IM_PRO_INPUT_PARAM_ERROR		: Setting NG
*/
INT32 impro_sensldiv_set_area( E_IM_PRO_LDIV_CH ch, TimproLdivArea* ldivArea )
{
#ifdef CO_PARAM_CHECK
	if (ldivArea == NULL){
...
@retval		D_IM_PRO_INPUT_PARAM_ERROR	: Setting NG
*/
INT32 impro_sensldiv_set_paen( E_IM_PRO_LDIV_CH ch, UCHAR paenTrg )
{
#ifdef CO_PARAM_CHECK
