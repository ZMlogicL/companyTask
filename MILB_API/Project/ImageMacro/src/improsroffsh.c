...
static const TimproRdmaFfshAddr S_G_IM_PRO_FFSH_ADDR[ImproBase_E_IM_PRO_UNIT_NUM_MAX][ImproSroffsh_D_IM_PRO_SRO_FFSH_CH_NUM] = {
	{
		{
...
static const UINT32	S_G_IM_PRO_FFSH_STATUS_TBL[ImproBase_E_IM_PRO_UNIT_NUM_MAX][ImproSroffsh_D_IM_PRO_SRO_FFSH_CH_NUM] = {
